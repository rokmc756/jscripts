...
a
        ...
        # vmrun deleteVM "Path to vmx file"
        os.system(VMWARE_CMD_BASE_DIR + " vmrun deleteVM " + VMWARE_IMG_BASE_DIR + PREFIX + ".vmwarevm/Virtual\ Disk.vmdk >> " + WORK_DIR + "/" + PREFIX + ".log 2>&1")
        # os.system("sudo virsh destroy " + PREFIX + " >> " + WORK_DIR + "/" + PREFIX + ".log 2>&1")
        # os.system("sudo virsh undefine " + PREFIX + " >> " + WORK_DIR + "/" + PREFIX + ".log 2>&1")


    # Looks like it only works for RHEL/CentOS 6
    ...
    def create_image(self, PREFIX, META_DATA, MEMORY, CPUS, TARGET_IMAGE, OSVAR, BASE_IMAGE):
        ...
        print "Cloning VM ..."
        # *************** 수정할것 source and destination
        os.system(VMWARE_CMD_BASE_DIR + "vmrun -T fusion clone " + VMWARE_IMG_BASE_DIR + PREFIX + ".vmwarevm/" + PREFIX + ".vmx full -cloneName=" + PREFIX )
